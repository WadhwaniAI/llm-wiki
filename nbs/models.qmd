...
[LLM Collection]([ChatBot Arena](https://lmsys.org/blog/2023-05-10-leaderboard/). Collection of many LLMs in one place -  check out other sections as well on prompt engineering.
...
Not based on LLaMA. Can use for commerical purposes.
