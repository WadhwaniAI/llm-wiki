...
Any Open Source reproduction of LLaMA for permissive commerical uses.
...
## Semi-Open Zoo
Many in this category are, for most part, are derivates of LLaMA. Since the LLaMA model weights were never released officially, the following only publish the weight deltas. Thefore, overall model is not permissive for commerical usages.
